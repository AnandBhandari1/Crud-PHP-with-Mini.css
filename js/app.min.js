...
var count=0;function loadsearch(t){$("#content2").empty(),loadjsonapidata(t)}function loadjsonapidata(t){$.getJSON(t,function(t){var e=[];$.each(t,function(t,n){var a=n.content2.split(",").map(function(t){return"<button class='small' onclick=loadsearch('api/searchtags.php?s="+t.trim()+"')>"+t.trim()+"</button>"}).join(" "),o="";""!=n.content4&&(o=o+'<img src="'+n.content4+'"  alt="'+n.content1+'" alt="'+n.content1+'">'),""!=n.content1&&(o+=n.content1),e.push('<div class="card_custom">'+o+"<p>"+a+'</p><p><a href="#" id="'+n.id+'" onclick=update('+n.id+')>Update</a> <a href="delete_gist.php?post_id='+n.id+'" >delete</a></p></div>')}),$("<div/>",{class:"row",html:e.join("")}).appendTo("#appdata")})}function highlightcode(){$("pre, code, .ql-syntax").each(function(t,n){hljs.highlightBlock(n)})}function loadtags(){$.getJSON("api/taglist.php",function(t){var a=[];$.each(t,function(t,n){a.push("<button class='btn btn-outline-seocndary d-flex justify-content-start align-items-center p-2' onclick=loadsearch('api/searchtags.php?s="+t+"')><i class='devicon-"+t+"-plain colored p-2'></i> "+t+"<span class='badge badge-light badge-pill ml-auto p-2'>"+n+"</span></button>")}),$("<ul/>",{class:"list-group",html:a.join("")}).appendTo("#tags")})}function update(t){$("#exampleModal").modal("show"),$.getJSON("api/singlepost.php?id="+t,function(t){$.each(t,function(t,n){$("#content1").val(n.content1);var a=n.content1,o=(new DOMParser).parseFromString("<!doctype html><body>"+a,"text/html").body.textContent;$("#content1").val(o),$("#content2").val(n.content2),quill.root.innerHTML=n.content2,$("#content2").val(n.content2),$("#post_id").val(n.id),$("#gist_slug").val(n.gist_slug),$("input[name=gist_type][value="+n.gist_type+"]").prop("checked",!0)})})}loadjsonapidata("./api/quotes.php"),$("#content1").on("keyup",function(){var t=nlp($("#content1").val());$("#gist_slug").val($.slugify(t.nouns().out("text").trim()))});var pagecount=0;$("#loadmorebtn").on("click",function(){loadjsonapidata("api/posts.php?count="+(pagecount+=10))});
!function($){"use strict";var TagSuggest=function(element,options){var ms=this,defaults={allowFreeEntries:!0,cls:"",data:null,dataUrlParams:{},disabled:!1,displayField:"name",editable:!0,emptyText:function(){return cfg.editable?"Type or click here":"Click here"},emptyTextCls:"tag-empty-text",expanded:!1,expandOnFocus:function(){return!cfg.editable},groupBy:null,hideTrigger:!1,highlight:!0,id:function(){return"tag-ctn-"+$('div[id^="tag-ctn"]').length},infoMsgCls:"",inputCfg:{},invalidCls:"tag-ctn-invalid",matchCase:!1,maxDropHeight:290,maxEntryLength:null,maxEntryRenderer:function(e){return"Please reduce your entry by "+e+" character"+(1<e?"s":"")},maxSuggestions:null,maxSelection:10,maxSelectionRenderer:function(e){return"You cannot choose more than "+e+" item"+(1<e?"s":"")},method:"POST",minChars:0,minCharsRenderer:function(e){return"Please type "+e+" more character"+(1<e?"s":"")},name:null,noSuggestionText:"No suggestions",preselectSingleSuggestion:!0,renderer:null,required:!1,resultAsString:!1,resultsField:"results",selectionCls:"",selectionPosition:"inner",selectionRenderer:null,selectionStacked:!1,sortDir:"asc",sortOrder:null,strictSuggest:!1,style:"",toggleOnClick:!1,typeDelay:400,useTabKey:!1,useCommaKey:!0,useZebraStyle:!0,value:null,valueField:"name",width:function(){return $(this).width()}},conf=$.extend({},options),cfg=$.extend(!0,{},defaults,conf);$.isFunction(cfg.emptyText)&&(cfg.emptyText=cfg.emptyText.call(this)),$.isFunction(cfg.expandOnFocus)&&(cfg.expandOnFocus=cfg.expandOnFocus.call(this)),$.isFunction(cfg.id)&&(cfg.id=cfg.id.call(this)),this.addToSelection=function(e,t){if(!cfg.maxSelection||_selection.length<cfg.maxSelection){$.isArray(e)||(e=[e]);var s=!1;$.each(e,function(e,t){-1===$.inArray(t[cfg.valueField],ms.getValue())&&(_selection.push(t),s=!0)}),!0===s&&(self._renderSelection(),this.empty(),!0!==t&&$(this).trigger("selectionchange",[this,this.getSelectedItems()]))}},this.clear=function(e){this.removeFromSelection(_selection.slice(0),e)},this.collapse=function(){!0===cfg.expanded&&(this.combobox.detach(),cfg.expanded=!1,$(this).trigger("collapse",[this]))},this.disable=function(){this.container.addClass("tag-ctn-disabled"),cfg.disabled=!0,ms.input.attr("disabled",!0)},this.empty=function(){this.input.removeClass(cfg.emptyTextCls),this.input.val("")},this.enable=function(){this.container.removeClass("tag-ctn-disabled"),cfg.disabled=!1,ms.input.attr("disabled",!1)},this.expand=function(){!cfg.expanded&&(this.input.val().length>=cfg.minChars||0<this.combobox.children().size())&&(this.combobox.appendTo(this.container),self._processSuggestions(),cfg.expanded=!0,$(this).trigger("expand",[this]))},this.isDisabled=function(){return cfg.disabled},this.isValid=function(){return!1===cfg.required||0<_selection.length},this.getDataUrlParams=function(){return cfg.dataUrlParams},this.getName=function(){return cfg.name},this.getSelectedItems=function(){return _selection},this.getRawValue=function(){return ms.input.val()!==cfg.emptyText?ms.input.val():""},this.getValue=function(){return $.map(_selection,function(e){return e[cfg.valueField]})},this.removeFromSelection=function(e,t){$.isArray(e)||(e=[e]);var n=!1;$.each(e,function(e,t){var s=$.inArray(t[cfg.valueField],ms.getValue());-1<s&&(_selection.splice(s,1),n=!0)}),!0===n&&(self._renderSelection(),!0!==t&&$(this).trigger("selectionchange",[this,this.getSelectedItems()]),cfg.expandOnFocus&&ms.expand(),cfg.expanded&&self._processSuggestions())},this.setData=function(e){cfg.data=e,self._processSuggestions()},this.setName=function(e){cfg.name=e,ms._valueContainer&&(ms._valueContainer.name=e)},this.setValue=function(data){var values=data,items=[];$.isArray(data)||("string"==typeof data?-1<data.indexOf("[")?values=eval(data):-1<data.indexOf(",")&&(values=data.split(",")):values=[data]),$.each(_cbData,function(e,t){-1<$.inArray(t[cfg.valueField],values)&&items.push(t)}),0<items.length&&this.addToSelection(items)},this.setDataUrlParams=function(e){cfg.dataUrlParams=$.extend({},e)};var _selection=[],_comboItemHeight=0,_timer,_hasFocus=!1,_groups=null,_cbData=[],_ctrlDown=!1,self={_displaySuggestions:function(e){ms.combobox.empty();var t=0,s=0;if(null===_groups)self._renderComboItems(e),t=_comboItemHeight*e.length;else{for(var n in _groups)s+=1,$("<div/>",{class:"tag-res-group",html:n}).appendTo(ms.combobox),self._renderComboItems(_groups[n].items,!0);t=_comboItemHeight*(e.length+s)}t<ms.combobox.height()||t<=cfg.maxDropHeight?ms.combobox.height(t):t>=ms.combobox.height()&&t>cfg.maxDropHeight&&ms.combobox.height(cfg.maxDropHeight),1===e.length&&!0===cfg.preselectSingleSuggestion&&ms.combobox.children().filter(":last").addClass("tag-res-item-active"),0===e.length&&""!==ms.getRawValue()&&(self._updateHelper(cfg.noSuggestionText),ms.collapse())},_getEntriesFromStringArray:function(e){var n=[];return $.each(e,function(e,t){var s={};s[cfg.displayField]=s[cfg.valueField]=$.trim(t),n.push(s)}),n},_highlightSuggestion:function(e){var t=ms.input.val()!==cfg.emptyText?ms.input.val():"";return 0===t.length?e:e=!0===cfg.matchCase?e.replace(new RegExp("("+t+")(?!([^<]+)?>)","g"),"<em>$1</em>"):e.replace(new RegExp("("+t+")(?!([^<]+)?>)","gi"),"<em>$1</em>")},_moveSelectedRow:function(e){var t,s,n,i;cfg.expanded||ms.expand(),t=ms.combobox.find(".tag-res-item"),s="down"===e?t.eq(0):t.filter(":last"),0<(n=ms.combobox.find(".tag-res-item-active:first")).length&&("down"===e?(0===(s=n.nextAll(".tag-res-item").first()).length&&(s=t.eq(0)),i=ms.combobox.scrollTop(),ms.combobox.scrollTop(0),s[0].offsetTop+s.outerHeight()>ms.combobox.height()&&ms.combobox.scrollTop(i+_comboItemHeight)):(0===(s=n.prevAll(".tag-res-item").first()).length&&(s=t.filter(":last"),ms.combobox.scrollTop(_comboItemHeight*t.length)),s[0].offsetTop<ms.combobox.scrollTop()&&ms.combobox.scrollTop(ms.combobox.scrollTop()-_comboItemHeight))),t.removeClass("tag-res-item-active"),s.addClass("tag-res-item-active")},_processSuggestions:function(e){var t=null,s=e||cfg.data;if(null!==s){if("function"==typeof s&&(s=s.call(ms)),"string"==typeof s&&s.indexOf(",")<0){$(ms).trigger("beforeload",[ms]);var n=$.extend({query:ms.input.val()},cfg.dataUrlParams);return void $.ajax({type:cfg.method,url:s,data:n,success:function(e){t="string"==typeof e?JSON.parse(e):e,self._processSuggestions(t),$(ms).trigger("load",[ms,t])},error:function(){throw"Could not reach server"}})}_cbData="string"==typeof s&&-1<s.indexOf(",")?self._getEntriesFromStringArray(s.split(",")):0<s.length&&"string"==typeof s[0]?self._getEntriesFromStringArray(s):s[cfg.resultsField]||s,self._displaySuggestions(self._sortAndTrim(_cbData))}},_render:function(e){$(ms).trigger("beforerender",[ms]);var t=$.isFunction(cfg.width)?cfg.width.call(e):cfg.width;switch(ms.container=$("<div/>",{id:cfg.id,class:"tag-ctn "+cfg.cls+(!0===cfg.disabled?" tag-ctn-disabled":"")+(!0===cfg.editable?"":" tag-ctn-readonly"),style:cfg.style}).width(t),ms.container.focus($.proxy(handlers._onFocus,this)),ms.container.blur($.proxy(handlers._onBlur,this)),ms.container.keydown($.proxy(handlers._onKeyDown,this)),ms.container.keyup($.proxy(handlers._onKeyUp,this)),ms.input=$("<input/>",$.extend({id:"tag-input-"+$('input[id^="tag-input"]').length,type:"text",class:cfg.emptyTextCls+(!0===cfg.editable?"":" tag-input-readonly"),value:cfg.emptyText,readonly:!cfg.editable,disabled:cfg.disabled},cfg.inputCfg)).width(t-(cfg.hideTrigger?16:42)),ms.input.focus($.proxy(handlers._onInputFocus,this)),ms.input.click($.proxy(handlers._onInputClick,this)),!1===cfg.hideTrigger&&(ms.trigger=$("<div/>",{id:"tag-trigger-"+$('div[id^="tag-trigger"]').length,class:"tag-trigger",html:'<div class="tag-trigger-ico"></div>'}),ms.trigger.click($.proxy(handlers._onTriggerClick,this)),ms.container.append(ms.trigger)),ms.combobox=$("<div/>",{id:"tag-res-ctn-"+$('div[id^="tag-res-ctn"]').length,class:"tag-res-ctn "}).width(t).height(cfg.maxDropHeight),ms.combobox.on("click","div.tag-res-item",$.proxy(handlers._onComboItemSelected,this)),ms.combobox.on("mouseover","div.tag-res-item",$.proxy(handlers._onComboItemMouseOver,this)),ms.selectionContainer=$("<div/>",{id:"tag-sel-ctn-"+$('div[id^="tag-sel-ctn"]').length,class:"tag-sel-ctn"}),ms.selectionContainer.click($.proxy(handlers._onFocus,this)),"inner"===cfg.selectionPosition?ms.selectionContainer.append(ms.input):ms.container.append(ms.input),ms.helper=$("<div/>",{class:"tag-helper "+cfg.infoMsgCls}),self._updateHelper(),ms.container.append(ms.helper),$(e).replaceWith(ms.container),cfg.selectionPosition){case"bottom":ms.selectionContainer.insertAfter(ms.container),!0===cfg.selectionStacked&&(ms.selectionContainer.width(ms.container.width()),ms.selectionContainer.addClass("tag-stacked"));break;case"right":ms.selectionContainer.insertAfter(ms.container),ms.container.css("float","left");break;default:ms.container.append(ms.selectionContainer)}self._processSuggestions(),null!==cfg.value&&(ms.setValue(cfg.value),self._renderSelection()),$(ms).trigger("afterrender",[ms]),$("body").click(function(e){ms.container.hasClass("tag-ctn-bootstrap-focus")&&0===ms.container.has(e.target).length&&e.target.className.indexOf("tag-res-item")<0&&e.target.className.indexOf("tag-close-btn")<0&&ms.container[0]!==e.target&&handlers._onBlur()}),!0===cfg.expanded&&(cfg.expanded=!1,ms.expand())},_renderComboItems:function(e,i){var a=this,o="";$.each(e,function(e,t){var s=null!==cfg.renderer?cfg.renderer.call(a,t):t[cfg.displayField],n=$("<div/>",{class:"tag-res-item "+(i?"tag-res-item-grouped ":"")+(e%2==1&&!0===cfg.useZebraStyle?"tag-res-odd":""),html:!0===cfg.highlight?self._highlightSuggestion(s):s,"data-json":JSON.stringify(t)});n.click($.proxy(handlers._onComboItemSelected,a)),n.mouseover($.proxy(handlers._onComboItemMouseOver,a)),o+=$("<div/>").append(n).html()}),ms.combobox.append(o),_comboItemHeight=ms.combobox.find(".tag-res-item:first").outerHeight()},_renderSelection:function(){var i=this,e=0,t=0,a=[],o=!0===cfg.resultAsString&&!_hasFocus;ms.selectionContainer.find(".tag-sel-item").remove(),void 0!==ms._valueContainer&&ms._valueContainer.remove(),$.each(_selection,function(e,t){var s,n=null!==cfg.selectionRenderer?cfg.selectionRenderer.call(i,t):t[cfg.displayField];!0===o?s=$("<div/>",{class:"tag-sel-item tag-sel-text "+cfg.selectionCls,html:n+(e===_selection.length-1?"":",")}).data("json",t):(s=$("<div/>",{class:"tag-sel-item "+cfg.selectionCls,html:n}).data("json",t),!1===cfg.disabled&&$("<span/>",{class:"tag-close-btn"}).data("json",t).appendTo(s).click($.proxy(handlers._onTagTriggerClick,i))),a.push(s)}),ms.selectionContainer.prepend(a),ms._valueContainer=$("<input/>",{type:"hidden",name:cfg.name,value:JSON.stringify(ms.getValue())}),ms._valueContainer.appendTo(ms.selectionContainer),"inner"===cfg.selectionPosition&&(ms.input.width(0),t=ms.input.offset().left-ms.selectionContainer.offset().left,e=ms.container.width()-t-42,ms.input.width(e),ms.container.height(ms.selectionContainer.height())),_selection.length===cfg.maxSelection?self._updateHelper(cfg.maxSelectionRenderer.call(this,_selection.length)):ms.helper.hide()},_selectItem:function(e){1===cfg.maxSelection&&(_selection=[]),ms.addToSelection(e.data("json")),e.removeClass("tag-res-item-active"),!1!==cfg.expandOnFocus&&_selection.length!==cfg.maxSelection||ms.collapse(),_hasFocus?_hasFocus&&(cfg.expandOnFocus||_ctrlDown)&&(self._processSuggestions(),_ctrlDown&&ms.expand()):ms.input.focus()},_sortAndTrim:function(e){var n=ms.getRawValue(),i=[],s=[],a=ms.getValue();return 0<n.length?$.each(e,function(e,t){var s=t[cfg.displayField];(!0===cfg.matchCase&&-1<s.indexOf(n)||!1===cfg.matchCase&&-1<s.toLowerCase().indexOf(n.toLowerCase()))&&(!1!==cfg.strictSuggest&&0!==s.toLowerCase().indexOf(n.toLowerCase())||i.push(t))}):i=e,$.each(i,function(e,t){-1===$.inArray(t[cfg.valueField],a)&&s.push(t)}),null!==cfg.sortOrder&&s.sort(function(e,t){return e[cfg.sortOrder]<t[cfg.sortOrder]?"asc"===cfg.sortDir?-1:1:e[cfg.sortOrder]>t[cfg.sortOrder]?"asc"===cfg.sortDir?1:-1:0}),cfg.maxSuggestions&&0<cfg.maxSuggestions&&(s=s.slice(0,cfg.maxSuggestions)),null!==cfg.groupBy&&(_groups={},$.each(s,function(e,t){void 0===_groups[t[cfg.groupBy]]?_groups[t[cfg.groupBy]]={title:t[cfg.groupBy],items:[t]}:_groups[t[cfg.groupBy]].items.push(t)})),s},_updateHelper:function(e){ms.helper.html(e),ms.helper.is(":visible")||ms.helper.fadeIn()}},handlers={_onBlur:function(){if(ms.container.removeClass("tag-ctn-bootstrap-focus"),ms.collapse(),_hasFocus=!1,""!==ms.getRawValue()&&!0===cfg.allowFreeEntries){var e={};e[cfg.displayField]=e[cfg.valueField]=ms.getRawValue(),ms.addToSelection(e)}self._renderSelection(),!1===ms.isValid()&&ms.container.addClass("tag-ctn-invalid"),""===ms.input.val()&&0===_selection.length?(ms.input.addClass(cfg.emptyTextCls),ms.input.val(cfg.emptyText)):""!==ms.input.val()&&!1===cfg.allowFreeEntries&&(ms.empty(),self._updateHelper("")),ms.input.is(":focus")&&$(ms).trigger("blur",[ms])},_onComboItemMouseOver:function(e){ms.combobox.children().removeClass("tag-res-item-active"),$(e.currentTarget).addClass("tag-res-item-active")},_onComboItemSelected:function(e){self._selectItem($(e.currentTarget))},_onFocus:function(){ms.input.focus()},_onInputClick:function(){!1===ms.isDisabled()&&_hasFocus&&!0===cfg.toggleOnClick&&(cfg.expanded?ms.collapse():ms.expand())},_onInputFocus:function(){if(!1===ms.isDisabled()&&!_hasFocus){_hasFocus=!0,ms.container.addClass("tag-ctn-bootstrap-focus"),ms.container.removeClass(cfg.invalidCls),ms.input.val()===cfg.emptyText&&ms.empty();var e=ms.getRawValue().length;!0===cfg.expandOnFocus&&ms.expand(),_selection.length===cfg.maxSelection?self._updateHelper(cfg.maxSelectionRenderer.call(this,_selection.length)):e<cfg.minChars&&self._updateHelper(cfg.minCharsRenderer.call(this,cfg.minChars-e)),self._renderSelection(),$(ms).trigger("focus",[ms])}},_onKeyDown:function(e){var t=ms.combobox.find(".tag-res-item-active:first"),s=ms.input.val()!==cfg.emptyText?ms.input.val():"";if($(ms).trigger("keydown",[ms,e]),9!==e.keyCode||!1!==cfg.useTabKey&&(!0!==cfg.useTabKey||0!==t.length||0!==ms.input.val().length))switch(e.keyCode){case 8:0===s.length&&0<ms.getSelectedItems().length&&"inner"===cfg.selectionPosition&&(_selection.pop(),self._renderSelection(),$(ms).trigger("selectionchange",[ms,ms.getSelectedItems()]),ms.input.focus(),e.preventDefault());break;case 9:case 188:case 13:e.preventDefault();break;case 17:_ctrlDown=!0;break;case 40:e.preventDefault(),self._moveSelectedRow("down");break;case 38:e.preventDefault(),self._moveSelectedRow("up");break;default:_selection.length===cfg.maxSelection&&e.preventDefault()}else handlers._onBlur()},_onKeyUp:function(e){var t,s=ms.getRawValue(),n=0<$.trim(ms.input.val()).length&&ms.input.val()!==cfg.emptyText&&(!cfg.maxEntryLength||$.trim(ms.input.val()).length<=cfg.maxEntryLength),i={};if($(ms).trigger("keyup",[ms,e]),clearTimeout(_timer),27===e.keyCode&&cfg.expanded&&ms.combobox.height(0),9===e.keyCode&&!1===cfg.useTabKey||13<e.keyCode&&e.keyCode<32)17===e.keyCode&&(_ctrlDown=!1);else switch(e.keyCode){case 40:case 38:e.preventDefault();break;case 13:case 9:case 188:if(188!==e.keyCode||!0===cfg.useCommaKey){if(e.preventDefault(),!0===cfg.expanded&&0<(t=ms.combobox.find(".tag-res-item-active:first")).length)return void self._selectItem(t);!0===n&&!0===cfg.allowFreeEntries&&(i[cfg.displayField]=i[cfg.valueField]=s,ms.addToSelection(i),ms.collapse(),ms.input.focus());break}default:_selection.length===cfg.maxSelection?self._updateHelper(cfg.maxSelectionRenderer.call(this,_selection.length)):s.length<cfg.minChars?(self._updateHelper(cfg.minCharsRenderer.call(this,cfg.minChars-s.length)),!0===cfg.expanded&&ms.collapse()):cfg.maxEntryLength&&s.length>cfg.maxEntryLength?(self._updateHelper(cfg.maxEntryRenderer.call(this,s.length-cfg.maxEntryLength)),!0===cfg.expanded&&ms.collapse()):(ms.helper.hide(),cfg.minChars<=s.length&&(_timer=setTimeout(function(){!0===cfg.expanded?self._processSuggestions():ms.expand()},cfg.typeDelay)))}},_onTagTriggerClick:function(e){ms.removeFromSelection($(e.currentTarget).data("json"))},_onTriggerClick:function(){if(!1===ms.isDisabled()&&(!0!==cfg.expandOnFocus||_selection.length!==cfg.maxSelection))if($(ms).trigger("triggerclick",[ms]),!0===cfg.expanded)ms.collapse();else{var e=ms.getRawValue().length;e>=cfg.minChars?(ms.input.focus(),ms.expand()):self._updateHelper(cfg.minCharsRenderer.call(this,cfg.minChars-e))}}};null!==element&&self._render(element)};$.fn.tagSuggest=function(i){var e=$(this);return 1===e.size()&&e.data("tagSuggest")?e.data("tagSuggest"):(e.each(function(e){var t=$(this);if(!t.data("tagSuggest")){"select"===this.nodeName.toLowerCase()&&(i.data=[],i.value=[],$.each(this.children,function(e,t){t.nodeName&&"option"===t.nodeName.toLowerCase()&&(i.data.push({id:t.value,name:t.text}),t.selected&&i.value.push(t.value))}));var s={};$.each(this.attributes,function(e,t){s[t.name]=t.value});var n=new TagSuggest(this,$.extend(i,s));t.data("tagSuggest",n),n.container.data("tagSuggest",n)}}),1===e.size()?e.data("tagSuggest"):e)}}(jQuery),$(document).ready(function(){for(var e=[],t="Apple,Orange,Banana,Strawberry".split(","),s=0;s<t.length;s++)e.push({id:s,name:t[s]});$("#content2").tagSuggest({data:e,sortOrder:"name",maxDropHeight:200,name:"content2"})});